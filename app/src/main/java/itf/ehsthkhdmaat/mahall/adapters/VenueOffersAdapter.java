...
public class VenueOffersAdapter extends ITFRecyclerViewAdapter<VenueOffer> {
...
//endregion /* =================================== Class Variable ========================================== */
    ...
    //region /* /* =================================== Constructors ============================================ */
    public VenueOffersAdapter(Context context) {
        super(context);
    }

    public VenueOffersAdapter(Context context, OnITFRecyclerViewItemClick<VenueOffer> listener) {
...
//endregion /* ================================ Getter - Setter Method ===================================== */
    ...
    protected View createView(Context context, ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_venue_offers, viewGroup, false);
        return v;
    }

    @Override
    protected void bindView(VenueOffer item, final ITFRecyclerViewAdapter.ViewHolder viewHolder, int position) {
        if (item != null) {
            VenueOffer dataModel = (VenueOffer) item;
            try {

                ITFImageView imgVenueOffers = (ITFImageView) viewHolder.getView(R.id.imgVenueOffers);
                UIHelper.setImageWithGlide(getContext(), imgVenueOffers, dataModel.getImageUrl());
