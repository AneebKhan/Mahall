...
public class TopRatedVenuesAdapter extends ITFRecyclerViewAdapter<Response> {
...
//endregion /* =================================== Class Variable ========================================== */
    ...
    //region /* /* =================================== Constructors ============================================ */
    public TopRatedVenuesAdapter(Context context) {
        super(context);
    }

    public TopRatedVenuesAdapter(Context context, OnITFRecyclerViewItemClick<Response> listener, ArrayList<Response> datalist) {
...
//endregion /* ================================ Getter - Setter Method ===================================== */
    ...
    protected View createView(Context context, ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_top_rated_venues, viewGroup, false);
        return v;
    }
    ...
    protected void bindView(Response item, final ITFRecyclerViewAdapter.ViewHolder viewHolder, int position) {
        if (item != null) {
            ...
            try {
                ...
                ITFTextView tvVenueName = (ITFTextView) viewHolder.getView(R.id.tvVenueName);
                ITFTextView tvVenueDesc = (ITFTextView) viewHolder.getView(R.id.tvVenueDesc);
                ITFImageView imgMarkFavourite = (ITFImageView) viewHolder.getView(R.id.imgMarkFavourite);
                com.makeramen.roundedimageview.RoundedImageView imgVenue = (com.makeramen.roundedimageview.RoundedImageView) viewHolder.getView(R.id.imgVenue);
                RatingBar rbCatRating = (RatingBar) viewHolder.getView(R.id.rbVenueRating);

                tvVenueName.setText(dataModel.getName());
                tvVenueDesc.setText(dataModel.getDetail());

                for (VenueGallery venueGallery: dataModel.getVenueGallery()) {

                    if (venueGallery.getIsDefault()) {
                        UIHelper.setImageWithGlide(getContext(), imgVenue, venueGallery.getUrl());
                        break;
                    }
