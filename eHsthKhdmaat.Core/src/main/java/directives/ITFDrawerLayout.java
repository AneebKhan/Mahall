...
public class ITFDrawerLayout extends DrawerLayout {
    private static final String TAG = ITFDrawerLayout.class.getSimpleName();
    ...
    public ITFDrawerLayout(Context context) {
        super(context);
        init(context, null, 0);

    }

    public ITFDrawerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);

    }

    public ITFDrawerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        addDrawerListener(new DrawerListener() {
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                ITFDrawerLayout.this.drawerView = drawerView;
