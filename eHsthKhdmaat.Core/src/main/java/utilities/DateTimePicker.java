...
import interfaces.onPickDateTimeListener;

import static utilities.DateFormatter.TRANSACTION_DATE_FORMAT;
import static utilities.DateFormatter.UI_DATE_FORMAT;
...
public class DateTimePicker {
    ...
    public void initDatePicker(Context _ctx, final String _delegate) {
        ...
        DatePickerDialog dialog = new DatePickerDialog(ctx, R.style.datePickerStyle, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(android.widget.DatePicker view, int year, int month, int dayOfMonth) {
                ...
                if (dateSpecified.before(date)) {
                    UIHelper.showShortToastInCenter(CustomApplication.getContext(), "Selected Date is in Past");
                } else {
        ...
        dialog.show();
        dialog.getButton(DatePickerDialog.BUTTON_POSITIVE).setTextColor(ContextCompat.getColor(CustomApplication.getContext(), R.color.colorWhite));
        dialog.getButton(DatePickerDialog.BUTTON_POSITIVE).setBackgroundColor(ContextCompat.getColor(CustomApplication.getContext(), R.color.colorPurple));
    }

    public void initDobDatePicker(Context _ctx, final String _delegate) {
    ...
    public void initTimePicker(Context _ctx, final String _delegate) {
        this.ctx = _ctx;
